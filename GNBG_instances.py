...
class GNBG:
    ...
    @classmethod
    def read_from_file(cls, problem_index: int) -> "GNBG":
        assert 1 <= problem_index <= 24, "ProblemIndex must be between 1 and 24."
        filename = f"problem_instances/f{ProblemIndex}.mat"
...
gnbg = GNBG.read_from_file(ProblemIndex)
Number_of_Solutions = 10000
X = np.random.rand(
    Number_of_Solutions, gnbg.Dimension
)  # This is for generating a random population of a number of solutions for testing GNBG
